...
model_path = "work_dir/stage1-1/VideoChat3_4B_train_stage0-1/xxxx/hf-190"
meta_data_path = 'training_data_annotations/stage0-2/data_stage0-2.json'
work_dir = "work_dir/stage0-2/VideoChat3_4B_train_stage0-2"
cache_dir = "dataset_cache/cache_videochat3_4B_stage0-2"
...
for name, _data in ds_collections.items():
    _data_cfg = {"dataset": DatasetConfig(name=name,
                 ...
                 "tokenize_fn": VideoChat3TokenizeFnConfig(
                    ...
                    video_max_frames=_data.get('video_max_frames', 512), 
