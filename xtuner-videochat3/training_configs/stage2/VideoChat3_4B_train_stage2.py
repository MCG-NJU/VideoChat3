...
model_path = "work_dir/VideoChat3_4B_train_stage1-2/xxxx/hf-1461"
meta_data_path = 'training_data_annotations/data_stage2.json'
work_dir = "work_dir/stage2/VideoChat3_4B_train_stage2"
cache_dir = "dataset_cache/cache_videochat3_4B_stage2"
...
for name, _data in ds_collections.items():
    _data_cfg = {"dataset": DatasetConfig(name=name,
                 ...
                 "tokenize_fn": VideoChat3TokenizeFnConfig(
                    ...
                    video_max_frames=_data.get('video_max_frames', 1024), 
